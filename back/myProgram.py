...
class TestApp(EWrapper, EClient):
    ...
    def tickSize(self, reqId, tickType, size):
        print("Tick Size. Ticker Id:", reqId, "Ticktype:", TickTypeEnum.to_str(tickType), "size:", price)


def main():
    print("Does this do anything1?")
    app = TestApp()
    ...
    #app.tickPrice(" ", 1, "STK", Price, attrib)
    print("Does this do anything?2")
