...
#MZ>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
#    dataTable = ""
#    datafile  = open("mytestdata.txt",'w')
...
#        print(ContractSamples.OptionForQuery)
        ...
        #myContract = ContractSamples.SimpleFuture
        #print(ContractSamples.SimpleFuture)
        ...
        queryTime = (datetime.datetime.today() - datetime.timedelta(days=10)).strftime("%Y%m%d %H:%M:%S")
        #self.reqHeadTimeStamp(4101, ContractSamples.SimpleFuture(), "TRADES", 0, 1)
        #self.reqHistoricalData(4102, ContractSamples.SimpleFuture(), queryTime,
        #                                              "1 D", "20 mins", "MIDPOINT", 1, 1, False, [])
        self.reqHeadTimeStamp(4101, ContractSamples.FuturesOnOptions(), "TRADES", 0, 1)
        self.reqHistoricalData(4102, ContractSamples.FuturesOnOptions(), queryTime,
                                                      "1 D", "20 mins", "MIDPOINT", 1, 1, False, [])
        print('---- in historical data --: ', ContractSamples.FuturesOnOptions())
