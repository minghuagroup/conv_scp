    ...
    for Strike in myStrikes:
        ...
        for Exp in myExpDates[0:3]:
            ...
            if(jj > 1):
                ...
                ax.scatter(x2, y2, color=Colors[jj], label=Exp, marker = '_',s=5)
            ...
            if(jj==1):
                ...
                for i in range(len(cticks)):
                    ...
                    if(i%10 == 1):
                        ...
                        b = a[4:6] + '/' + a[6:8]
                    cticks[i].set_text(b)
                print('cticks1a', len(cticks),cticks)
                print('len(x2),x[0],x[-1]:',len(x2),x2[0],x2[-1])
        ...
        if(jj > 0):
            ...
            print('cticks2a', len(cticks2),cticks2)
            print('len(x2),x[0],x[-1]:', len(x2), x2[0], x2[-1])
