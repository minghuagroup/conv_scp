...
#
Trading_cost = 0.0065 #+ myStrikes[0]*0.001 #bid ask
...
for ii in range(len(x2)):
    ...
    if(ii == 0):
        ...
        if(TradingDay):
            ...
            pass
        Balance.append(StkPrice - OptPrice + Cash)
        yCash[ii] = Cash
        yShort[ii] = OptPrice
...
#plt.figure()
Title =  ' Balance with Short ' + mySymbol + ' Covered-Call at Strike ' +str(myStrikes[0])+myRights[0]
ax3 = plt.subplot(413)
