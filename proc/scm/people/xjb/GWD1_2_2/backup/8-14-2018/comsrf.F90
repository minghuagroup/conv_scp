...
! Jinbo Xie1
!================
public std,hgt_m,oc,oa1,oa2,oa3,oa4,ol1,ol2,ol3,ol4
        real(r8), allocatable:: std(:,:) ! Convexity
        real(r8), allocatable:: hgt_m(:,:) !
	real(r8), allocatable:: oc(:,:) ! Convexity
	real(r8), allocatable:: oa1(:,:) ! Asymmetry
	real(r8), allocatable:: oa2(:,:) !
	real(r8), allocatable:: oa3(:,:) !
	real(r8), allocatable:: oa4(:,:) !
	real(r8), allocatable:: ol1(:,:) ! Effective length
    real(r8), allocatable:: ol2(:,:) !
    real(r8), allocatable:: ol3(:,:) !
    real(r8), allocatable:: ol4(:,:) !
...
!================
                ...
                allocate (hgt_m(pcols,begchunk:endchunk))
		allocate (oc(pcols,begchunk:endchunk))
		allocate (oa1(pcols,begchunk:endchunk))
		allocate (oa2(pcols,begchunk:endchunk))
		allocate (oa3(pcols,begchunk:endchunk))
		allocate (oa4(pcols,begchunk:endchunk))
		allocate (ol1(pcols,begchunk:endchunk))
		allocate (ol2(pcols,begchunk:endchunk))
		allocate (ol3(pcols,begchunk:endchunk))
        allocate (ol4(pcols,begchunk:endchunk))
		!
