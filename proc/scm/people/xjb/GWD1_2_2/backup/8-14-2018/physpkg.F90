...
!===========
  ...
  use comsrf,              only: landm, sgh, sgh30,std,hgt_m,oc,oa1,oa2,oa3,oa4,ol1,ol2,ol3,ol4!add 10other pars
!===========
! Jinbo Xie
!===========
...
! Jinbo Xie2
!==============
	call gw_intr(state, sgh, pbuf, ztodt, ptend, cam_in%landfrac,std,hgt_m,oc,oa1,oa2,oa3,oa4,ol1,ol2,ol3,ol4)
!==============
! Jinbo Xie2
!==============
    call physics_update(state, ptend, ztodt, tend)
