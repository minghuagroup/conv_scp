...
! Jinbo Xie
!===========
  use physconst,        only: latvap, latice, rh2o,   r_universal!change constant
  use comsrf,              only: landm, sgh, sgh30,var,hgt_m,oc,oa1,oa2,oa3,oa4,ol1,ol2,ol3,ol4!add 10other pars
!===========
! Jinbo Xie
!===========
...
!============Jinbo Xie============
    use cam_initfiles,       only: initial_file_get_id, topo_file_get_id,  topoGWD_file_get_id
!============Jinbo Xie============
...
!=================
! add here
		fh_topoGWD=>topoGWD_file_get_id()
!Jinbo Xie
#if 0
                call infld('VAR' , fh_topoGWD, dim1name, 'lat', 1, pcols, begchunk, &  endchunk,  var, found, grid_map='PHYS')
                call infld('HGT_M', fh_topoGWD, dim1name, 'lat', 1, pcols, begchunk, &
endchunk, hgt_m, found, grid_map='PHYS')
		call infld('CON' , fh_topoGWD, dim1name, 'lat', 1, pcols, begchunk, &  endchunk,   oc, found, grid_map='PHYS')
                call infld('OA1', fh_topoGWD, dim1name, 'lat', 1, pcols, begchunk, &
endchunk,  oa1, found, grid_map='PHYS')
		call infld('OA2', fh_topoGWD, dim1name, 'lat', 1, pcols, begchunk, &
endchunk,  oa2, found, grid_map='PHYS')
		call infld('OA3', fh_topoGWD, dim1name, 'lat', 1, pcols, begchunk, &  endchunk,  oa3, found, grid_map='PHYS')
		call infld('OA4', fh_topoGWD, dim1name, 'lat', 1, pcols, begchunk, &  endchunk,  oa4, found, grid_map='PHYS')
		call infld('OL1', fh_topoGWD, dim1name, 'lat', 1, pcols, begchunk, &  endchunk,  ol1, found, grid_map='PHYS')
		call infld('OL2', fh_topoGWD, dim1name, 'lat', 1, pcols, begchunk, &
endchunk,  ol2, found, grid_map='PHYS')
		call infld('OL3', fh_topoGWD, dim1name, 'lat', 1, pcols, begchunk, &
endchunk,  ol3, found, grid_map='PHYS')
		call infld('OL4', fh_topoGWD, dim1name, 'lat', 1, pcols, begchunk, &
endchunk,  ol4, found, grid_map='PHYS')
#endif
!Jinbo Xie
                call infld('VAR_full' , fh_topoGWD, dim1name, 'lat', 1, pcols, begchunk, endchunk,  var, found, grid_map='PHYS')
                call infld('HGT_M_mean', fh_topoGWD, dim1name, 'lat', 1, pcols,begchunk, endchunk, hgt_m, found, grid_map='PHYS')
                call infld('CON_full' , fh_topoGWD, dim1name, 'lat', 1, pcols,begchunk,  endchunk,  oc, found, grid_map='PHYS')
                call infld('OA1_full', fh_topoGWD, dim1name, 'lat', 1, pcols,begchunk,   endchunk,  oa1, found, grid_map='PHYS')
                call infld('OA2_full', fh_topoGWD, dim1name, 'lat', 1, pcols,begchunk,   endchunk,  oa2, found, grid_map='PHYS')
                call infld('OA3_full', fh_topoGWD, dim1name, 'lat', 1, pcols,begchunk,   endchunk,  oa3, found, grid_map='PHYS')
                call infld('OA4_full', fh_topoGWD, dim1name, 'lat', 1, pcols,begchunk,   endchunk,  oa4, found, grid_map='PHYS')
                call infld('OL1_full', fh_topoGWD, dim1name, 'lat', 1, pcols,begchunk,   endchunk,  ol1, found, grid_map='PHYS')
                call infld('OL2_full', fh_topoGWD, dim1name, 'lat', 1, pcols,begchunk,   endchunk,  ol2, found, grid_map='PHYS')
                call infld('OL3_full', fh_topoGWD, dim1name, 'lat', 1, pcols,begchunk,   endchunk,  ol3, found, grid_map='PHYS')
                call infld('OL4_full', fh_topoGWD, dim1name, 'lat', 1, pcols,begchunk,   endchunk,  ol4, found, grid_map='PHYS')
...
! Jinbo Xie2
!==============
	call gw_intr(state, sgh, pbuf, ztodt, ptend, cam_in%landfrac,var,hgt_m,oc,oa1,oa2,oa3,oa4,ol1,ol2,ol3,ol4)
!==============
! Jinbo Xie2
!==============
    call physics_update(state, ptend, ztodt, tend)
...
!write(*,*) "Check gwdrag energy integrals"
...
!write(*,*) "store dse after tphysac in buffer"
...
!write(*,*) "aqua Energy budget checks"
