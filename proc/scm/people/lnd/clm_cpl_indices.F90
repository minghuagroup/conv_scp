...
! zmh added 4 fields
  integer, public ::index_l2x_Sl_tref2         ! 2m reference temperature
  integer, public ::index_l2x_Sl_qref2         ! 2m reference specific humidity
  integer, public ::index_l2x_Fall_lat2        ! latent          heat flux
  integer, public ::index_l2x_Fall_sen2        ! sensible        heat flux
...
!zmh
    index_l2x_Sl_tref2       = mct_avect_indexra(l2x,'Sl_tref2')
    index_l2x_Sl_qref2       = mct_avect_indexra(l2x,'Sl_qref2')
    index_l2x_Fall_lat2      = mct_avect_indexra(l2x,'Fall_lat2')
    index_l2x_Fall_sen2      = mct_avect_indexra(l2x,'Fall_sen2')
