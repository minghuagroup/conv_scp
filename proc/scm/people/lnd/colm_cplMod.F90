...
!zmh added 4 fields
   real(r8), pointer :: lnd_shflx2(:)
   real(r8), pointer :: lnd_lhflx2(:)
   real(r8), pointer :: lnd_tref2(:)
   real(r8), pointer :: lnd_qref2(:)
...
! zmh added
      allocate (lnd_shflx2  (numgrid))
      allocate (lnd_lhflx2  (numgrid))
      allocate (lnd_tref2   (numgrid))
      allocate (lnd_qref2   (numgrid))
...
!zmh added
         lnd_shflx2(g) = fldv%fsena2(g)
         lnd_lhflx2(g) = fldv%lfevpa2(g)
         lnd_tref2(g)  = fldv%tref2(g)
         lnd_qref2(g)  = fldv%qref2(g)
...
! zmh
      write(6,*) 'lnd_shflx_std', minval(lnd_shflx2)   , maxval(lnd_shflx2)
      write(6,*) 'lnd_lhflx_std', minval(lnd_lhflx2)   , maxval(lnd_lhflx2)
      write(6,*) 'lnd_tref_std' , minval(lnd_tref2)    , maxval(lnd_tref2)
      write(6,*) 'lnd_qref_std' , minval(lnd_qref2)    , maxval(lnd_qref2)
#endif
...
! routine:
      ...
      deallocate (lnd_nee  )
!zmh
      deallocate (lnd_shflx2)
      deallocate (lnd_lhflx2)
      deallocate (lnd_tref2 )
      deallocate (lnd_qref2 )
