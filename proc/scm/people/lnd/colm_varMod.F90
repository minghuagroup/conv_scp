...
! zmh added two fields
           real(r8), pointer :: fsena2(:)
           real(r8), pointer :: lfevpa2(:)
           ...
           real(r8), pointer :: qref(:)
! zmh added two fields
           real(r8), pointer :: tref2(:)
           real(r8), pointer :: qref2(:)
...
! zmh Zhang Minghua added 4 fields
      allocate (fldv%fsena2     (numgrid))
      allocate (fldv%lfevpa2    (numgrid))
      allocate (fldv%tref2      (numgrid))
      allocate (fldv%qref2      (numgrid))
...
!zmh
      deallocate (fldv_pft%tref2   )
      deallocate (fldv_pft%qref2   )
      deallocate (fldv_pft%fsena2  )
      deallocate (fldv_pft%lfevpa2 )
...
! average from column level
   ...
   subroutine colm_var_alloc2
      ...
      use paramodel, only: nflai, nfvar_col, nfvar_pft, &
