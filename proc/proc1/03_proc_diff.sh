...
set test_casename  = fc35x_0104RR10 #fc35_213 #ptest60 #casadv2e
#                    ??????????????
...
set test_path_history =  {$PWD}/{$test_casename}
set test_path_climo =    {$PWD}/{$test_casename}
set test_path_diag  =    {$PWD}/{$test_casename}/{$test_casename}_diag/
...
set cntl_casename   = fc35x_0104 #fc35_123 #20181225 #fc35_123 #ptest59 #castest2
#                    ??????????????
...
set cntl_path_history =  {$PWD}/{$cntl_casename}
set cntl_path_climo =    {$PWD}/{$cntl_casename}
#set cntl_path_history =  {$PWD}/{$cntl_casename}a
#set cntl_path_climo =    {$PWD}/{$cntl_casename}a
