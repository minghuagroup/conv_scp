...
# !! 2_proc_obs $1 for diff with obs
...
set test_casename  = fc35_642zyxpbl  #x_0104RR10
  #fc35x_0104 #fc35_213 #famip5cx_20181221b #ptest59 #castest2  #casadv2e
...
cp -L $PWD/02_proc_obs.sh $test_path_diag/  
...
set test_first_yr = 1979 #0001           # first year (must be >= 1)
...
set cntl_first_yr = 0001        # first year (must be >= 1)
...
#set test_name = beta05p2k  #cam3_5_test               # test case name 
#set cntl_name = beta05ctl  #cam3_5_cntl               # control case name
...
#setenv DIAG_HOME /T1/xxie/modeldata/amwgdiag
