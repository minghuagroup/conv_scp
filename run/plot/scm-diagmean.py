...
camttend_all = fc/cp*f.variables['camstend'][:,::-1,0].T
...
camqtend_all = lat/cp*fc*f.variables['camqtend'][:,::-1,0].T
...
plt.plot( ttend_all, z, 'b.-', alpha=0.1)
plt.plot( qtend_all, z, 'g.--', alpha=0.1)
...
plt.plot( camttend_all, z, 'b.-', alpha=0.1)
plt.plot( camqtend_all, z, 'g.--', alpha=0.1)
...
plt.savefig('plot/scm-diagmean.png', dpi=200, bbox_inches='tight', pad_inches=0)
