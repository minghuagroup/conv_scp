...
#for itime in [97]:
    ...
    #plt.axhline(y=zf[kupbase], lw=1, color='m')
    ...
    plt.xlabel("w(10 ms-1) dash and normflux")
    plt.xlim(-1, 10)
    ...
    plt.savefig('plot/detail-'+("%03d" % (itime+1) )+'.png', dpi=120, bbox_inches='tight', pad_inches=0)
