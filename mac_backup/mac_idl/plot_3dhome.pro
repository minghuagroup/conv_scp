 ...
 pro plot_3dhome,aa,xinp,yinp,levels,title=title,maxv=maxv,minv=minv,line=line,$
...
;=============
 ...
 contour,a,x,y,xstyle=1,ystyle=1,levels=levels,c_label=c_labels,$
  ...
  yticks=yticks,ytickv=ytickv,ytickname=ytickn,xticklen=0.04,yminor=2,/fill,color=nlv
 endelse
