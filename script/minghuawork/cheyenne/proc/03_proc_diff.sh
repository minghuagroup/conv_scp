...
set test_casename  = F2000COSZ5 #MG4
...
set cntl_casename   = F2000MG4 #MG2 #F2000SCP #F2000Climo 
...
echo 'to do cpcloud the file  to cloud /ds/mzhang/diag2/tmp for cp to www/diag/temp for web'
