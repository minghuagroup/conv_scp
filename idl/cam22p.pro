...
vars = ['TMQ']
vars = ['PRECCDZM']
vars = ['PRECT','PRECCDZM','PRECCSH','PRECL','TMQ']
...
if(belongsto(var,['PRECT','PRECCDZM','PRECCSH','PRECL','PRECC']) )then begin
aa  = reform(dd3[*,*,it]) *86400.*1000.
...
titlew = caseiap+'_h'+strtrim(ih,2)+'_'+var
