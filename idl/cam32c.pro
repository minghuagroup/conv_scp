; ncks -v CLDTOT,CLDLOW,CLDHGH,CLDMED,TGCLDLWP,TGCLDIWP,TGCLDCWP,CLOUD,CLDLIQ,CLDICE,TMQ,PRECC,PRECL,PRECCDZM,PRECT,TMQ,PBLH,LWCF,SWCF
...
vars = ['LWCF','SWCF']
vars = ['FLNT','FLNTC','FSNT','FSNTC','FSDS','FSDSC']
