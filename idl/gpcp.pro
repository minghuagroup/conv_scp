...
filein2='../obs/gpcp_v2.2_psg.2008'
read_gpcp, filein2, precip, 2008  

titlename= 'gpcp_'+months[nf]+'_'

print,filein2,'  ',titlename

 x2 = indgen(144)*2.5+1.25 
 y2  =indgen(72)*2.5-88.25  & y2=-y2
...
;====================
 ...
 yy = y2
  ...
  case VARS[iv]of 
   ...
   'PRECT':     begin & aa2 = reform(precip[*,*,nf*6]) &  levc=lev_prect & end
