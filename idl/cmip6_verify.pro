...
cmip_ncfiles = [ 'CMIP_piControl.nc', 'CMIP_1pctCO2.nc', 'CMIP_abrupt-4xCO2.nc', 'CMIP_amip.nc', 'CMIP_amip.nc']
scen_ncfiles = ['ScenarioMIP_ssp126.nc', 'ScenarioMIP_ssp245.nc', 'ScenarioMIP_ssp370.nc', 'ScenarioMIP_ssp585.nc']
f1 = ncdir + '/CMIP_amip/CMIP_amip_01_climo.nc'
f2 = ncdir + '/CMIP_amip/CMIP_amip_07_climo.nc'
