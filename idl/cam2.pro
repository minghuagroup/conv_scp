...
titlename= icase+'_3h_201707'+finday[iday]+'_'+fins[ih]+'_'
if(iday gt 4)then titlename= icase+'_3h_201708'+finday[iday]+'_'+fins[ih]+'_'
;------------------
kf = kf+1
km = kf
filein2 = fileins[0]
...
print,filein2,'  ',titlename
 ...
 precip = reform(prect[*,*,km-1])*1000.*86400 
...
;====================
 ...
 yy = y2
  ...
  case VARS[iv]of 
   'PRECT':     begin & aa2 = precip &  levc=lev_prect & end          ;mm/day
