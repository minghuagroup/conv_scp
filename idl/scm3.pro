;igif=1
;this is dump, scm2s to do customized
...
vars3= ['WGUSTD', 'WSUB', 'WTKE','buoy_dn','buoy_up','cldsr','dd0',$
 'dd1','det_org','det_tot','det_turb', $
 'du0','du1','ed0','ed1','ent_org','ent_tot','ent_turb','eps0', 'eu0',$
 'eu1','md0','md1','mu0','mu1','w_up']
...
;================
  ...
  var = vars2[iv]
  if(not belongsto(var,vars3))then begin ;================
   goto, jump_var
  endif
...
window,/free,xsize=600,ysize=460,title = title
  ...
  if(var eq 'md1')then begin
    get_lev,aa,'buoy_up',levc,scale
    scale = scale*0.1
  endif
