...
print,'run 00_range.pro and trmm_head.pro first!'
read,ix

kf=0
FOR  iday = 0,ndays-1 DO BEGIN
FOR  ih = 0,6 DO BEGIN  ; ----------- do different hours
;=======================================================

titlename= 'TRMM_3h_201707'+finday[iday]+'_'+fins[ih]+'_'
if(iday gt 4)then titlename= 'TRMM_3h_201708'+finday[iday]+'_'+fins[ih]+'_'
;------------------
...
;====================
 ...
 yy = y2
  ...
  case VARS[iv]of 
   'PRECT':     begin & aa2 = precip*24 &  levc=lev_prect & end          ;mm/day
...
if(icoarse)then begin
 ...
 jj=where(aa le 1.0e-2,cnt) & if(cnt gt 0)then aa[jj]= -9999.
 bb=aa 
