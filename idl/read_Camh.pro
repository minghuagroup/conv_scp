...
print,filein2
print,' run 3d_range first ok ?? 1 for yes'
read,ix


goto,jump1  ; read data from saved file======
...
;====================
 ...
 zz = Z2
  case iv of 
   0: begin & aa2 = T2          &  levc=lev_T & end
   1: begin & aa2 = Q2          &  levc=lev_Q & end
   2: begin & aa2 = W2          &  levc=lev_W & end
   3: begin & aa2 = RH2         &  levc=lev_RH & end
   4: begin & aa2 = U2          &  levc=lev_U & end
   5: begin & aa2 = V2          &  levc=lev_V & end
   6: begin & aa2 = cloud2      &  levc=lev_cld & end
   7: begin & aa2 = cldliq2     &  levc=lev_cldliq & end
   8: begin & aa2 = cldice2     &  levc=lev_cldliq & end
   9: begin & aa2 = cldice2+cldliq2  &  levc=lev_cldliq & end
   else:
  endcase
