...
nann = 12
filein   = caseid+'_monthly_'+var+'_1979-01.nc'
...
; specify what field types to plot and lev1 ===========================
...
; 6a ==  extract data and calc climatology & anomaly ==========
 ...
 endcase
     ...
     if(strpos(region, 'East') ge 0)then lev1 = cal_lev([0.,10],20)
;!!!!!!!!!!!!!!!!!!
