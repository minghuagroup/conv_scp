...
; endelse
varsp = ['PRECC','PRECL','PRECCDZM','PRECT','PRECCSH','PRECSH']
...
vars = ['U']
vars = ['CLDTOT','CLDLOW','CLDHGH','CLDMED']
vars = ['TGCLDLWP','TGCLDIWP','TGCLDCWP']
vars = ['PRECSH']
vars = ['CLDLOW']
vars = ['T','Q']
vars = ['PRECC']
vars = ['PRECSH','PRECC','PRECCDZM']
vars = ['PRECL','PRECCDZM','PRECT','PRECSH']
vars = ['TMQ']
vars = ['CLDLIQ','CLDICE','CLOUD']
vars = ['TGCLDLWP','TGCLDIWP']
vars = ['CLDLOW','CLDHGH','CLDMED']
vars = ['PRECL','PRECCDZM','PRECT','PRECSH','TMQ']
