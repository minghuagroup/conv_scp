 ...
 pro plot_map,aa,xinp,yinp,levels,title=title,maxv=maxv,minv=minv,line=line,$
    ...
    nxp=nxp,nxx0=nxx0,avex=avex,$
        ...
        mapcolor=mapcolor,mapfill=mapfill,lat1=lat1,lon1=lon1
; lat1 and lon1 are for a line cross section
...
;  print,sx,sy
 ...
 if(keyword_set(lat1) and keyword_set(lon1))then begin
   oplot,lon1,lat1,thick=2 ;,color=colors.red
  endif
