 ...
 pro plot_i4dhtml,aa,bb,x,y,levelsco,levelsct,title=title,$
     maxv=maxv,minv=minv,line=line,xtitle=xtitle,ytitle=ytitle,$
     tran=tran,fac=fac,xx2=xx2,yy2=yy2, $
        xrange=xrange,yrange=yrange,missing=missing
...
;=============
 ...
 contour,a,x,y,xstyle=1,ystyle=1,levels=levels,c_label=c_labels,$
  ...
  yticks=8,ytickv=ytickv,ytickname=ytickn,xticklen=0.04,yminor=2,/fill,$
    color=nlv,background_color=[255,255,255],irregular=1
...
; c_colors=c_colors[0:1]
 ...
 contour,a,x,y,xstyle=1,ystyle=1,levels=levels,c_label=c_labels,$
  ...
  xticklen=0.04,yminor=2,/fill,color=nlv,xrange=xrange,yrange=yrange,irregular=1
...
;stop
 contour,b,xx2,yy2,levels=levels2,c_label=c_labels, c_colors=c_c,/overplot,$
    c_lines=c_lines,/Follow,xrange=xrange,yrange=yrange,min_value=missing,irregular=1
