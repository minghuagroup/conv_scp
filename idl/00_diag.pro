...
idata = 50 ; case amwg diagnostic package
...
;==================
 ...
 50: begin
  ...
  icase = 'cesmke20'
  case_test = 'cesm20ctl'
  case_cntl = 'cesm20kectl'

;  icase = 'cesm20'
;  case_test = 'cesm20ctl'
;  case_cntl = 'beta05ctl'  ; resolution different

  expid = [case_test,case_cntl]

  datatype2 = case_test+'_'+case_cntl
  ...
  filein2 = file_test  
  filecam_sav = [file_test,file_cntl]
