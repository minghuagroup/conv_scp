...
write(*,*) "Jinbo Xie","Initialize CAM MPI communicator, number of processors, master processors"
   !	
#if ( defined SPMD )
...
write(*,*) "Jinbo Xie", "Determine input namelist filename"
   filein = "atm_in" // trim(inst_suffix)
write(*,*) "Jinbo Xie", "filein",filein
   !
...
write(*,*) "Jinbo Xie","read namelist for offline unit driver up"
   call offline_driver_readnl(filein)
write(*,*) "Jinbo Xie","read namelist for offline unit driver down"
