...
!locally added gw and bl drag
    real(r8) :: dusfc_gw(pcols)          
    real(r8) :: dvsfc_gw(pcols)
...
!===========
	...
	rublten=utgw(:,pver:1:-1),rvblten=vtgw(:,pver:1:-1),rthblten=ttgw(:,pver:1:-1),	&
        dusfcg_ls=dusfc_gw,dvsfcg_ls=dvsfc_gw,dusfcg_bl=dusfc_bl,dvsfcg_bl=dvsfc_bl,&
...
! Compute the temperature tendency from energy conservation (includes spectrum).
        ...
        !tau0x=0 
        !tau0y=0
        tau0x=dusfc_gw+dusfc_bl
        tau0y=dvsfc_gw+dvsfc_bl
        !=============
