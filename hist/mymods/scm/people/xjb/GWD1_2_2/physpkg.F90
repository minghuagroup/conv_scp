...
!Jinbo Xie
!#if 0
               call infld('HGT_M', fh_topoGWD, dim1name, 'lat', 1, pcols, begchunk, & endchunk, hgt_m, found, grid_map='PHYS')
		...
		call infld('CON' , fh_topoGWD, dim1name, 'lat', 1, pcols, begchunk, &  endchunk,   oc, found, grid_map='PHYS')
                call infld('OA1', fh_topoGWD, dim1name, 'lat', 1, pcols, begchunk, &  endchunk,  oa1, found, grid_map='PHYS')
		call infld('OA2', fh_topoGWD, dim1name, 'lat', 1, pcols, begchunk, &  endchunk,  oa2, found, grid_map='PHYS')
		...
		call infld('OL2', fh_topoGWD, dim1name, 'lat', 1, pcols, begchunk, &  endchunk,  ol2, found, grid_map='PHYS')
		call infld('OL3', fh_topoGWD, dim1name, 'lat', 1, pcols, begchunk, &  endchunk,  ol3, found, grid_map='PHYS')
		call infld('OL4', fh_topoGWD, dim1name, 'lat', 1, pcols, begchunk, &  endchunk,  ol4, found, grid_map='PHYS')
!#endif
!Jinbo Xie
