...
!zhang minghua modify
  integer :: index_x2a_Sx_tref2         ! 2m reference temperature        
  integer :: index_x2a_Sx_qref2         ! 2m reference specific humidity  
  integer :: index_x2a_Faxx_lat2        ! latent          heat flux       
  integer :: index_x2a_Faxx_sen2        ! sensible        heat flux       
...
!zhang minghua modify
    index_x2a_Sx_tref2       = mct_avect_indexra(x2a,'Sx_tref2')
    index_x2a_Sx_qref2       = mct_avect_indexra(x2a,'Sx_qref2')
    index_x2a_Faxx_lat2      = mct_avect_indexra(x2a,'Faxx_lat2')
    index_x2a_Faxx_sen2      = mct_avect_indexra(x2a,'Faxx_sen2')
