...
!zhang minghua modify
     real(r8) :: lhf2(pcols)              ! latent heat flux
     real(r8) :: shf2(pcols)              ! sensible heat flux
     real(r8) :: tref2(pcols)             ! ref height surface air temp
     real(r8) :: qref2(pcols)             ! ref height specific humidity 
...
!Zhang Minghua modify
       cam_in(c)%lhf2      (:) = 0._r8
       cam_in(c)%shf2      (:) = 0._r8
       cam_in(c)%tref2     (:) = 0._r8
       cam_in(c)%qref2     (:) = 0._r8
