...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 18, & ! number of photolysis reactions
                            rxntot = 99, & ! number of total reactions
                            gascnt = 81, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 54, & ! number of "gas phase" species
                            nfs = 3, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 262, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 49, & ! number of species in implicit class
