...
!--------------------------------------------------------------------
         ...
         loss(42) = (rxt(20)* y(2) +rxt(27)* y(3) +rxt(50)* y(6) +rxt(53)* y(7) &
                  +rxt(34)* y(18) +rxt(39)* y(19) +rxt(45)* y(20) +rxt(64)* y(22) &
                  +rxt(91)* y(30) + rxt(2) + rxt(3) + het_rates(1))* y(1)
         prod(42) =rxt(19)*y(2)
         loss(45) = (rxt(20)* y(1) + 2._r8*rxt(21)* y(2) +rxt(48)* y(6) + (rxt(51) + &
                 rxt(52))* y(7) +rxt(58)* y(8) +rxt(83)* y(16) +rxt(38)* y(19) &
                  +rxt(44)* y(20) +rxt(47)* y(21) +rxt(67)* y(24) + rxt(19) &
                  + het_rates(2))* y(2)
         prod(45) = (rxt(22) +rxt(23))*y(3) +rxt(3)*y(1) +rxt(5)*y(7) +rxt(6)*y(8) &
                  +rxt(37)*y(20)*y(18) +rxt(41)*y(19)*y(19)
         loss(47) = (rxt(27)* y(1) + (rxt(25) +rxt(26))* y(4) + (rxt(30) +rxt(31) + &
                 rxt(32))* y(12) +rxt(28)* y(31) +rxt(29)* y(32) +rxt(24)* y(54) &
                  + rxt(22) + rxt(23) + het_rates(3))* y(3)
         prod(47) =rxt(2)*y(1)
         loss(35) = ((rxt(79) +rxt(80))* y(19) + het_rates(17))* y(17)
         prod(35) = (rxt(11) +rxt(12) +rxt(81)*y(8) +rxt(82)*y(19) +rxt(83)*y(2)) &
                 *y(16) +.050_r8*rxt(91)*y(30)*y(1)
         loss(1) = ( + het_rates(5))* y(5)
         prod(1) = 0._r8
         loss(44) = (rxt(50)* y(1) +rxt(48)* y(2) +rxt(57)* y(8) +rxt(84)* y(13) &
                  +rxt(49)* y(20) +rxt(71)* y(24) + het_rates(6))* y(6)
         prod(44) = (rxt(5) +.500_r8*rxt(94) +rxt(51)*y(2))*y(7) &
                  +2.000_r8*rxt(25)*y(4)*y(3) +rxt(7)*y(8)
         loss(46) = (rxt(53)* y(1) + (rxt(51) +rxt(52))* y(2) +rxt(54)* y(8) +rxt(56) &
                 * y(19) +rxt(61)* y(20) +rxt(72)* y(24) + rxt(5) + rxt(94) &
                  + het_rates(7))* y(7)
         prod(46) = (rxt(48)*y(2) +rxt(49)*y(20) +rxt(50)*y(1) + &
         ...
         loss(48) = (rxt(39)* y(1) +rxt(38)* y(2) +rxt(56)* y(7) +rxt(59)* y(8) &
                 ...
                 * y(24) +rxt(90)* y(30) +rxt(95)* y(34) + (rxt(96) +rxt(97))* y(35) &
                  + het_rates(19))* y(19)
         prod(48) = (2.000_r8*rxt(35)*y(18) +rxt(44)*y(2) +rxt(45)*y(1) + &
                 rxt(49)*y(6) +rxt(60)*y(8) +rxt(66)*y(22))*y(20) + (rxt(47)*y(21) + &
                 rxt(83)*y(16))*y(2) + (rxt(30)*y(12) +2.000_r8*rxt(24)*y(54))*y(3) &
                  + (rxt(10) +.300_r8*rxt(89)*y(19))*y(14) +rxt(34)*y(18)*y(1) &
                  +.500_r8*rxt(94)*y(7) +rxt(8)*y(10) +2.000_r8*rxt(13)*y(21) +rxt(14) &
                 *y(28)
         loss(49) = (rxt(58)* y(2) +rxt(57)* y(6) +rxt(54)* y(7) +rxt(81)* y(16) &
                  +rxt(59)* y(19) +rxt(60)* y(20) +rxt(98)* y(35) + rxt(6) + rxt(7) &
                  + rxt(93) + het_rates(8))* y(8)
         prod(49) = (rxt(52)*y(2) +rxt(53)*y(1))*y(7) +rxt(8)*y(10) +rxt(55)*y(11) &
                  +rxt(15)*y(29)
         loss(2) = ( + het_rates(9))* y(9)
         prod(2) = (rxt(93) +rxt(81)*y(16) +rxt(98)*y(35))*y(8) + (.500_r8*rxt(94) + &
                 rxt(56)*y(19))*y(7) +2.000_r8*rxt(92)*y(11)
         loss(33) = (rxt(62)* y(19) + rxt(8) + rxt(9) + rxt(63) + het_rates(10)) &
                 * y(10)
         prod(33) =rxt(61)*y(20)*y(7)
         loss(27) = ( + rxt(55) + rxt(92) + het_rates(11))* y(11)
         prod(27) =rxt(54)*y(8)*y(7)
         loss(38) = (rxt(84)* y(6) + 2._r8*(rxt(86) +rxt(87))* y(13) +rxt(85)* y(20) &
                  + het_rates(13))* y(13)
         prod(38) = (rxt(30)*y(3) +rxt(78)*y(19))*y(12) +1.860_r8*rxt(91)*y(30)*y(1) &
                  +.700_r8*rxt(89)*y(19)*y(14)
         loss(34) = (rxt(89)* y(19) + rxt(10) + het_rates(14))* y(14)
         prod(34) =rxt(85)*y(20)*y(13)
         loss(40) = (rxt(83)* y(2) +rxt(81)* y(8) +rxt(82)* y(19) + rxt(11) + rxt(12) &
                  + het_rates(16))* y(16)
         prod(40) = (rxt(84)*y(6) +2.000_r8*rxt(86)*y(13) +rxt(87)*y(13))*y(13) &
                  + (rxt(31)*y(12) +rxt(32)*y(12))*y(3) + (rxt(10) + &
                 .300_r8*rxt(89)*y(19))*y(14) +.870_r8*rxt(91)*y(30)*y(1) &
                  +rxt(88)*y(19)*y(15)
         loss(39) = (rxt(34)* y(1) + (rxt(35) +rxt(36) +rxt(37))* y(20) + rxt(33) &
                  + het_rates(18))* y(18)
         prod(39) = (rxt(38)*y(2) +rxt(79)*y(17) +rxt(82)*y(16))*y(19) +rxt(31)*y(12) &
                 *y(3) +rxt(10)*y(14) +2.000_r8*rxt(11)*y(16)
         loss(43) = (rxt(45)* y(1) +rxt(44)* y(2) +rxt(49)* y(6) +rxt(61)* y(7) &
         ...
         prod(43) = (rxt(39)*y(1) +rxt(43)*y(21) +rxt(59)*y(8) +rxt(68)*y(24) + &
                 rxt(80)*y(17) +rxt(88)*y(15) +.500_r8*rxt(97)*y(35))*y(19) &
                  ...
                  +rxt(33)*y(18)
         loss(32) = (rxt(47)* y(2) +rxt(43)* y(19) + rxt(13) + het_rates(21))* y(21)
         prod(32) = (.500_r8*rxt(99) +rxt(46)*y(20))*y(20) +rxt(42)*y(19)*y(19)
         loss(36) = (rxt(24)* y(3) + het_rates(54))* y(54)
         prod(36) = (rxt(78)*y(12) +rxt(40)*y(20) +rxt(41)*y(19) +rxt(43)*y(21) + &
                 rxt(62)*y(10) +rxt(82)*y(16) +rxt(89)*y(14))*y(19) +rxt(37)*y(20) &
                 *y(18)
         loss(37) = (rxt(64)* y(1) + (rxt(65) +rxt(66))* y(20) + het_rates(22))* y(22)
         prod(37) = (rxt(67)*y(2) +rxt(68)*y(19) +rxt(71)*y(6) + &
         ...
         loss(41) = (rxt(67)* y(2) +rxt(71)* y(6) +rxt(72)* y(7) + (rxt(68) +rxt(69)) &
                 * y(19) +rxt(70)* y(20) + 2._r8*(rxt(73) +rxt(74) +rxt(75) +rxt(76)) &
                 * y(24) + het_rates(24))* y(24)
         prod(41) = (rxt(64)*y(1) +rxt(66)*y(20))*y(22) +2.000_r8*rxt(77)*y(26) &
                  +rxt(16)*y(29)
         loss(4) = ( + het_rates(25))* y(25)
         prod(4) =rxt(75)*y(24)*y(24)
         loss(24) = ( + rxt(77) + het_rates(26))* y(26)
         prod(24) =rxt(76)*y(24)*y(24)
         loss(5) = ( + het_rates(27))* y(27)
         prod(5) =rxt(69)*y(24)*y(19) +rxt(65)*y(22)*y(20)
         loss(26) = ( + rxt(14) + het_rates(28))* y(28)
         prod(26) =rxt(70)*y(24)*y(20)
         loss(30) = ( + rxt(15) + rxt(16) + het_rates(29))* y(29)
         prod(30) =rxt(72)*y(24)*y(7)
         loss(31) = (rxt(91)* y(1) +rxt(90)* y(19) + het_rates(30))* y(30)
         prod(31) = 0._r8
         loss(28) = (rxt(88)* y(19) + het_rates(15))* y(15)
         prod(28) =rxt(87)*y(13)*y(13)
         loss(25) = (rxt(95)* y(19) + het_rates(34))* y(34)
         prod(25) = (rxt(96)*y(19) +.500_r8*rxt(97)*y(19) +rxt(98)*y(8))*y(35)
         loss(29) = (rxt(98)* y(8) + (rxt(96) +rxt(97))* y(19) + het_rates(35))* y(35)
         prod(29) = 0._r8
