...
!---------------------------------------------------------------------------------
   ...
   use physconst,    only: cpair, rair, zvir, latvap, latice                              
...
!
    ...
    cmedp_idx     = pbuf_get_index('CMEDP')
...
!
   ...
   call pbuf_get_field(pbuf, slflxdp_idx,     slflx )
   call pbuf_get_field(pbuf, qtflxdp_idx,     qtflx )
!
