  ...
  !--------------------------------------------------- !
   ...
   use wv_saturation,    only: qsat_water, svp_water, svp_ice, qsat
   ...
   public :: ini_macro, mmacro_pcond_pbl, aist_vector, aist_single, astG_RHU_single, astG_PDF_single, CAMstfrac
   ...
   use cloud_fraction,   only : cldfrc_implicit_PDF
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      call cldfrc_implicit_PDF( lchnk, ncol, pbuf, zm, shflx, lhflx,  &
                   p, T, qv, ql, qi, &
                   dt, rhc_null, rhc_null, a_st_pbl, cmeliq_null, cu_pbl_top )

      call cldfrc_implicit_PDF( lchnk, ncol, pbuf, zm, shflx, lhflx,  &
                   p, T, qv*1.01_r8, ql, qi, &
                   dt, rhc_null, rhc_null, a_st_pbl_perturb, cmeliq_null, cu_pbl_top )
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
