  ...
  call pbuf_add_field('wush',       'physpkg' ,dtype_r8,(/pcols,pverp/),      wush_idx )
  call pbuf_add_field('slflxsh',    'physpkg' ,dtype_r8,(/pcols,pverp/),      slflxsh_idx )
  call pbuf_add_field('qtflxsh',    'physpkg' ,dtype_r8,(/pcols,pverp/),      qtflxsh_idx )
...
!   real(r8) :: qtflx(pcols,pverp)                                        ! Shallow convective total water flux
   ...
   case('UW')   ! UW shallow convection scheme
      ...
      call pbuf_get_field(pbuf, wush_idx, wu_out)
      call pbuf_get_field(pbuf, slflxsh_idx, slflx)
      call pbuf_get_field(pbuf, qtflxsh_idx, qtflx)
      ...
      call compute_uwshcu_inv( pcols     , pver    , ncol           , pcnst         , ztodt         ,                   &
			       ...
			       flxprec, flxsnow, 			         					&
                               ...
                               cnt2                , cnb2           , lchnk         , state%pdeldry ,  wu_out )
