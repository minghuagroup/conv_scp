...
!zmh 2018-09-12 program not changed because ISTAR=1
   !use flexib,     only: IBCFFT
   use flexib,     only: IBCFFT, DTlin, DTadv, Ndt
...
!   write(*,*) 'ISTAR, PWX(IB,beglatdyn)',ISTAR, IB,beglev,beglatdyn,PXW3(IB,beglatdyn)
