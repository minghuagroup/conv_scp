...
set test_casename  = zyx_camtrigedy #zyxdef #zyx_trn12_trg1_edy
   #zyxdef #zyxevp #conv6scp2 #conv6zm #AMIP_ctl
...
set test_first_yr = 0001           # first year (must be >= 1)
...
#setenv DIAG_HOME /T1/mzhang/modeldata/amwgdiag
...
ls -l *.tar
echo mv $test_path_diag/*.tar ../../www_gcm
mv $test_path_diag/*.tar ../../www_gcm
echo 'ready in ../www_gcm for viewing!'
