...
!   use flexib,    only:  b1, b21, b22, c10, kappa, kappa2, IBCFFT, Kstd
   use flexib,    only:  b1, b21, b22, c10, kappa, kappa2, IBCFFT, Kstd, &
            geoadpu, geoadpv, zmh_nth, zmh_sth, DTlin, Ndt                     !zmh added
...
!zmh 2018.08.25
   logical               :: geostrophic_adj = .true.  !.False. for default, .True. for geos adjustments
...
!zmh
   integer  :: KK, I, J, K,ierr,J1,J2 ,ITER, NX2,NY2,NZ2,NNX, NNY,NNZ!zmh                 ! loop index
   integer  :: JM1,JP1,KP1,KM1 !zmh                 ! loop index
...
!
               OPCT0 = b0 * TT(I  ,K,J) * (1. - deltap(I  ,K,J)) / Pstar1(I  ,J)  ! zmh 2018.08.25
...
!=============================== zhh =====================================
               IF (abs(DU(I,K,J)) > 5E-1 .OR. abs(DV(I,K,J)) > 5E-1 .or.      &
                  ...
                  print*, 'ZMH_DU(',I,K,J,') =', ZMH_DU(I,K,J)
                  print*, 'ZMH_DV(',I,K,J,') =', ZMH_DV(I,K,J)
!                  print*, 'ZMH_GHI(',I,K,J,') =', ZMH_GHI(I,K,J),ZMH_GHI(I+1,K,J)
!                  print*, 'ZMH_GHI1(',I,K,J,') =', ZMH_GHI1(I,K,J),ZMH_GHI1(I+1,K,J)
