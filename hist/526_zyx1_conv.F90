...
!zmh =================================
   ...
   logical           :: do_dcape = .true. !.false. !true. !false.
...
!zmh -----------
   logical, dimension(pcols,8) :: deep_triggers
...
!zmh
   do i = 1,ncol
    ...
    seed1(i) = abs(t(i,3) - t(i,pver))  * 1000000
    seed1(i) = abs(t(i,5) - t(i,pver))  * 1000000
    seed1(i) = abs(t(i,7) - t(i,pver))  * 1000000
   enddo
...
!       deep_triggers(i,2) = (cape(i)  > bfls_cape(i))

       deep_triggers(i,3) = (omega(i,k750(i)) < 0._r8 )             !kpbl(i)
       if(deep_triggers(i,3))then
        w11 = zmh_ramp(-omega(i,k750(i)),0._r8,1.e-5_r8)
        ramp(i) = ramp(i)*w11
       endif

       deep_triggers(i,4) = (precw(i) > 0.8_r8*precws(i))       ! 0.70 default
