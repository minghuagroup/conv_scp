...
#MZ >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    def USOptionContract():
        #! [optcontract_us]
        contract = Contract()
        contract.symbol = "LYFT" #AAPL" #SPY" #GOOG"
        contract.secType = "OPT"
        contract.exchange = "SMART"
        contract.currency = "USD"
        contract.lastTradeDateOrContractMonth = "202012" #20190315"
        contract.strike = 25 #1180
        contract.right = "C"
        contract.multiplier = "100"
        #! [optcontract_us]
        return contract
#MZ <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
    ...
    def OptionAtBOX():
        ...
        contract.currency = "USD"
        contract.lastTradeDateOrContractMonth = "20210315"
        contract.strike = 1380
        contract.right = "C"
        contract.multiplier = "100"
        #! [optcontract]
        return contract
    ...
    def FuturesOnOptions():
        ...
        contract.exchange = "GLOBEX"
        contract.currency = "USD"
        contract.lastTradeDateOrContractMonth = "20201113"
...
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    def OptionForQuery():
        ...
        contract = Contract()
# MZ
        contract.symbol = "LYFT" #AAPL" #LYFT" #AAPL"  "FISV"
        contract.secType = "STK" #STK" #OPT"
        contract.exchange = "SMART"
        contract.currency = "USD"
        #contract.strike = 20 #120
        #contract.right = "C"
        #contract.multiplier = "100"
        #contract.lastTradeDateOrContractMonth = "20210621"
        #! [optionforquery]
        return contract
...
#MZ  >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    def myOPT_Contract():
        ...
        contract.exchange = "SMART"
        contract.currency = "USD"
        contract.lastTradeDateOrContractMonth = "20201113" #"201912"  # 20190315"
        contract.strike = 24 # 25  # 1180
        contract.right = "P"
        contract.multiplier = "100"
        # ! [optcontract_us]
        return contract
