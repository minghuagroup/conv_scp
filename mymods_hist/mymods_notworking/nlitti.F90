...
!------------------------------------------------------------------------------------------------
   ...
   use flexib,    only : DTlin, DTadv, Ndt, Istar, zmh_nlitti  !zmh
...
!zmh 2018-09-12  removed the backward integration, embedded substepping
 if(zmh_nlitti) then
...
! ============================================
!------------------------------------------------------------------------------------------------
!zmh 2018-09-12 added the following if to improve numerical stability

 if( .not. zmh_nlitti) then
