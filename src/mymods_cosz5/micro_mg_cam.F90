...
!MZ<XX
   call addfld ('LIQSHAPE', '1', 1, 'A', 'Subgrid Variability Shape Parameter for Liquid'  ,phys_decomp)
   call addfld ('STAB', '1', 1, 'A', 'Stability Parameter for Subgrid Shape Parameter for Liquid' ,phys_decomp)
!>
...
contains
  ...
  subroutine micro_mg1_0_tend_intr
    use micro_mg1_0, only: micro_mg_tend_MZ
...
!MZ>
    !call micro_mg_tend( &
    call micro_mg_tend_MZ( &
!>
         microp_uniform, pcols, pver, ncol, top_lev, dtime, &
!MZ<
         state%ulat, state%zm, state%lchnk,&
!>
    ...
    call handle_errmsg(errstring, subname="micro_mg_tend_MZ")
