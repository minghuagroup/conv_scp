...
!MZtest 2018-08-05
  ...
  real(r8),         parameter :: tunl           =   0.05_r8    ! Asympt leng = tunl*(turb lay depth)
        ...
        !                In addition, our current formulation does not consider ice contribution. 
          ...
          elseif( choice_radf .eq. 'maxi' ) then
                ...
                ! 2. From 'kt-1' layer and add the contribution from 'kt' layer
                  ...
                  !write(*,*)' Eddy1 ---- lwp,radinvfrac,radf,qrlw chs(i,kt)'
                  !write(*,*)'           ',lwp,radinvfrac,radf,qrlw(i,kt),chs(i,kt)
...
!tunable
          ...
          evhc = 1.0_r8* (1._r8 + cldeff(i,k)*(evhc-1._r8) )
          radf = 1.0_r8*radf

          !write(*,*)'-----------'
          !write(*,*)'in eddy...evhc, radf, opt_depth, radinvfrac'
          !write(*,*),evhc, radf, opt_depth, radinvfrac
          !write(*,*)'lwp,qrlw(i,kt)',lwp,qrlw(i,kt)*86400./cpair/( pi(i,kt) - pi(i,kt+1))
