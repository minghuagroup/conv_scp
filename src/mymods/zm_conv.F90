...
!xiex
                    outtends, outtendq, &
                    outcondtends, outcondtendq, &
                    outtranuptends, outtranuptendq, &
...
!xiex
   real(r8) :: condtends(pcols,pver)
   real(r8) :: condtendq(pcols,pver)
   real(r8) :: tranuptends(pcols,pver)
   real(r8) :: tranuptendq(pcols,pver)
   real(r8) :: trandntends(pcols,pver)
   real(r8) :: trandntendq(pcols,pver)
   real(r8), intent(out) :: outtends(pcols,pver)
   real(r8), intent(out) :: outtendq(pcols,pver)
   real(r8), intent(out) :: outcondtends(pcols,pver)
   real(r8), intent(out) :: outcondtendq(pcols,pver)
   real(r8), intent(out) :: outtranuptends(pcols,pver)
   real(r8), intent(out) :: outtranuptendq(pcols,pver)
   real(r8), intent(out) :: outtrandntends(pcols,pver)
   real(r8), intent(out) :: outtrandntendq(pcols,pver)
   real(r8), intent(out) :: outmb(pcols)
   real(r8), intent(out) :: outmu(pcols,pver)
   real(r8), intent(out) :: outsu(pcols,pver)
   real(r8), intent(out) :: outqu(pcols,pver)
...
!xiex
   ...
   outtranuptendq = 0._r8
   outtrandntends = 0._r8
...
!xiex
   ...
   real(r8) fscale_up(pcols,pver)
   real(r8) entrain_rates_bulk_up(pcols,pver)
   real(r8) detrain_rates_bulk_up(pcols,pver)
...
!xiex
   real(r8),intent(out) :: dsdtcond(pcols,pver),dqdtcond(pcols,pver)
   real(r8),intent(out) :: dsdttranup(pcols,pver),dqdttranup(pcols,pver)
   real(r8),intent(out) :: dsdttrandn(pcols,pver),dqdttrandn(pcols,pver)
