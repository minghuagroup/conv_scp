...
! MZ
    ...
    use nnparameter,   only: nnmodel, negqtendadj, nn_type, nn_flag
...
!xiex
   ...
   real(r8) :: outmu(pcols,pver)    ! scattrd version of the detraining cld h2o tend
   real(r8) :: outsu(pcols,pver)    ! scattrd version of the detraining cld h2o tend
   real(r8) :: outqu(pcols,pver)    ! scattrd version of the detraining cld h2o tend
   real(r8) :: outtends(pcols,pver)    ! scattrd version of the detraining cld h2o tend
   real(r8) :: outtendq(pcols,pver)    ! scattrd version of the detraining cld h2o tend

   real(r8) :: outcondtends(pcols,pver)    ! scattrd version of the detraining cld h2o tend
   real(r8) :: outcondtendq(pcols,pver)    ! scattrd version of the detraining cld h2o tend
   real(r8) :: outtranuptends(pcols,pver)    ! scattrd version of the detraining cld h2o tend
   real(r8) :: outtranuptendq(pcols,pver)    ! scattrd version of the detraining cld h2o tend
   real(r8) :: outtrandntends(pcols,pver)    ! scattrd version of the detraining cld h2o tend
   real(r8) :: outtrandntendq(pcols,pver)    ! scattrd version of the detraining cld h2o tend
...
!xiex
                    outtends, outtendq, &
                    outcondtends, outcondtendq, outtranuptends, outtranuptendq, &
